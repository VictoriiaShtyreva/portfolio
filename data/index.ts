...
export const gridItems = [
  ...
  },
  {
    ...
    title: "Communication",
    description:
      "My experience as a Research Assistant at BIOCAD and as a developer has taught me the importance of clear and open communication. I believe in working closely with my team to understand our collective goals and deliver effective solutions.",
  ...
  {
    id: 5,
    title: "Currently building the Event Management System API",
    description:
  ...
  {
    id: 6,
    title: "Do you want to see my accomplishments?",
    description:
      "Explore my recent certifications and achievements to see my skills and how I can contribute to your team.",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const pdfFiles = ["/1.pdf", "/2.pdf", "/3.pdf", "/4.pdf", "/5.pdf"];
